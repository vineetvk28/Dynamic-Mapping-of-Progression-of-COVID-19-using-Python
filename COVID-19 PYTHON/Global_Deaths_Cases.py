...
data=pd.read_csv("/Users/vineetkargeti/Downloads/COVID-19-master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv")
data.head(10)
...
#map title
    ax.set_title('Global Deaths  '+dates,fontdict={'fontsize':20},pad=12.5)
#Move the axes
    ax.set_axis_off()
#Move the legend
...
#Creating a GIF file
image_frames[0].save('Dynamic Covid 19 Trial Deaths.gif',
                     format='GIF',
