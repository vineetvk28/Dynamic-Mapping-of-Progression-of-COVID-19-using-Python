...
data=pd.read_csv("/Users/vineetkargeti/Downloads/COVID-19-master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recovered_global.csv")
data.head(10)
...
#Creating a GIF file
image_frames[0].save('Dynamic Covid 19 Trial 1.gif',
                     format='GIF',
...
#cmap=colormap #scheme to define the color intervals
#map title
    ax.set_title('Global Recovery Corona Virus Cases  '+dates,fontdict={'fontsize':20},pad=12.5)
#Move the axes
    ax.set_axis_off()
#Move the legend
    ax.get_legend().set_bbox_to_anchor((0.18,0.16))
...
#Creating a GIF file
image_frames[0].save('Dynamic Covid 19 Trial Recovery.gif',
                     format='GIF',
                     append_images=image_frames[1:],
                     save_all=True,
                     duration=600,
